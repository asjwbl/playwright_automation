...
export class ViewCartDialog {
    ...
    get continueShoppingButton(): ButtonComponent {
        if (!this._continueShoppingButton) {
            this._continueShoppingButton = new ButtonComponent(this.page, 'button:has-text("Continue Shopping")');
        }
    ...
    get viewCartButton(): ButtonComponent {
        if (!this._viewCartButton) {
            this._viewCartButton = new ButtonComponent(this.page, 'u:has-text("View Cart")');
        }
