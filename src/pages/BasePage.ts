...
export class BasePage {
   ...
   */
  async waitForPageLoad(expectedTitle: string, timeout: number = 30000): Promise<void> {
    try {
      ...
      console.error(`Page load failed or title mismatch. Expected title: ${expectedTitle}`);
      throw error;
    }
  }
