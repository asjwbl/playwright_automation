...
export class ProductsPage extends BasePage {
  ...
  get searchInput(): InputComponent {
    return this._searchInput ??= new InputComponent(this.page, 'input[name="search"]');
  }

  // Getter for the search button
  get searchButton(): ButtonComponent {
    return this._searchButton ??= new ButtonComponent(this.page, 'button[id="submit_search"]');
  }
