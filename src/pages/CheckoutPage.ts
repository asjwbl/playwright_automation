...
export class CheckoutPage {
  ...
  get placeOrderButton(): ButtonComponent {
    if (!this._placeOrderButton) {
      this._placeOrderButton = new ButtonComponent(
        this.page,
  ...
  get payAndConfirmOrderButton(): ButtonComponent {
    if (!this._payAndConfirmOrderButton) {
      this._payAndConfirmOrderButton = new ButtonComponent(
        this.page,
  ...
  get orderCommentInput(): TextAreaComponent {
    if (!this._orderCommentInput) {
      this._orderCommentInput = new TextAreaComponent(
        this.page,
  ...
  async enterPaymentDetails(paymentDetails: {
    ...
    const nameOnCardInput = new InputComponent(
      this.page,
      'input[name="name_on_card"]'
    );
    const cardNumberInput = new InputComponent(
      this.page,
      'input[name="card_number"]'
    );
    const cvcInput = new InputComponent(this.page, 'input[name="cvc"]');
    const expirationMonthInput = new InputComponent(
      this.page,
      'input[name="expiry_month"]'
    );
    const expirationYearInput = new InputComponent(
      this.page,
