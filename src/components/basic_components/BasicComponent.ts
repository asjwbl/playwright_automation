...
export class BasicComponent {
     ...
     */
    static byRole<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, role: AriaRole, options?: { name?: string }): T {
     ...
     * @returns A new instance of the derived component class.
     */
    static byLabel<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, label: string): T {
     ...
     * @returns A new instance of the derived component class.
     */
    static byPlaceholder<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, placeholder: string): T {
     ...
     * @returns A new instance of the derived component class.
     */
    static byTestId<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, testId: string): T {
     ...
     * @returns A new instance of the derived component class.
     */
    static byAltText<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, altText: string): T {
     ...
     * @returns A new instance of the derived component class.
     */
    static byTitle<T extends BasicComponent>(this: new (page: Page, locator: Locator) => T, page: Page, title: string): T {
